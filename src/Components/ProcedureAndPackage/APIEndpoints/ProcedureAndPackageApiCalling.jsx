...
import { checkAuthExist, getSessionStorage } from "../../../API methods/AUTH/Auth";
import  CustomMsg  from "../../../API methods/Utilities/CustomErrorMsg";
const pako = require("pako");

export const ProcedureAndPackageApiCalling = async (requestApiData, apiPath, commonName, header) => {
    debugger;
